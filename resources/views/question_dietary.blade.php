...
<head>
    ...
    <title>Question Dietary Food</title>
...
<body>
    ...
    <div class="bg-background flex justify-center items-center min-h-screen w-full  ">
        <div class="bg-white m-auto  w-[600px] h-[700px] border bg-white shadow rounded-xl">
            ...
            <h1 class="font-bold text-4xl mt-14 text-center">Dietary Preferences</h1>

            <p class="text-xl text-center mt-12"> Do you have any dietary restrictions or allergies?
            </p>
            ...
            <div class="mt-32 ml-16">
                <a href="{{ route('question_accessibility') }}" class="text-primary px-9 py-4 bg-white shadow border rounded-lg">Previous</a>
                <a href="{{ route('question_dislike') }}" class="text-bold text-white bg-primary px-14 rounded-lg py-4 shadow border ml-44">Next</a>
            </div>
        </div>
    </div>
</body>
